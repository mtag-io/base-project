<div class='mt-lg'>
    ...
    <div>
        <p class='font-semibold text-sm lg:text-lg text-justify'>
            "Just wanted to say thank you for all your help so far and we are very happy with
            the quality of the audio that we have received."</p>
        <p class='text-right font-bold'>Victoria Law – Advitel</p>
        <p class='text-right font-bold'> Ltd. - UK</p>
    </div>
    ...
    <div>
        <p class='font-semibold text-sm lg:text-lg text-justify'>"This [audio] is absolutely *splendid*! Thank you
            very much for the swift turnaround and superb audio!"</p>
        <p class='text-right font-bold'>Bev Mayo - Studio Tech, Premier CX - UK</p>
    </div>
    ...
    <div>
        <p class='font-semibold text-sm lg:text-lg text-justify'>"We would like to thank you for the last recordings
            ...
            influence the quality."</p>
        <p class='text-right font-bold'>Weerapat Sakulrat – EQHO Communication - Thailand</p>
    </div>
    ...
    <div>
        <p class='font-semibold text-sm lg:text-lg text-justify'>"Thanks!! Sounded great – Srirupa [Bengali Voice
            ...
            all-good.
            It’s pretty easy to check through your work since you’ve already QC’d it. We like it!"</p>
        <p class='text-right font-bold'>Todd Griffin – Manager, Solutions on Hold, Inc. - USA</p>
    </div>
    ...
    <div>
        <p class='font-semibold text-sm lg:text-lg text-justify'>"Just thought I'd send a quick email to say thank
            you for all your help this week with the many voice-overs we have had to rush through you!
            You have been very accommodating!"</p>
        <p class='text-right font-bold'> Simon Robinson - Adelphi Translations Ltd - UK</p>
    </div>
